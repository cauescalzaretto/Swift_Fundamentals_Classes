...
//    // Definição da classe com propriedades e métodos
//}
...
//=======================================================================================================================
// PROPRIEDADES ou atributos, são as características de um objeto definidas dentro do escopo de uma classe.
//
...
class Animal {
    ...
    //Declaração de propriedades
    var peso: Double = 0.0
    var altura: Double = 0.0
    var idade: Int = 0
    
    // Declaração dos métodos
    func comer(){
